...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.tab_search, R.string.tab_favorites};
    ...
    public Fragment getItem(int position) {
        ...
        if (position == 0) {
            return MovieSearchListFragment.newInstance();
        } else {
            return MovieFavoriteListFragment.newInstance();
        }
    }
